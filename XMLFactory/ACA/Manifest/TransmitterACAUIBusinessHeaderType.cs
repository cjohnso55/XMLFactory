...
/****************************************************************************  
    ...
    "C:\Program Files (x86)\Xsd2Code\xsd2code.exe"  .\IRS-ACAUserInterfaceHeaderMessage.xsd VCS.Viewpoint.XmlFactory.PR.ACA.Manifest IRS-ACAUserInterfaceHeaderMessage.cs /lic .\xsd2code.license /p Net45 /dmnOnlyIfDiff /dmxmli+ /if+ /uct+ /is /xml /encUTF8 /in+ /sm Serialize /dm Deserialize /sf SaveToFile /lf LoadFromFile /expattg /appinfo+ /sc+ /rt+ /rtrange /rtregex /rtstlength /pfnu /xa+ /xao+
...
namespace XMLFactory.ACA.Manifest
{
    ...
    public partial class TransmitterACAUIBusinessHeaderType : IRootXmlClass
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute(Namespace="urn:us:gov:treasury:irs:ext:aca:air:ty16", Order=1)]
